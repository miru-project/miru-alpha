...
extension MobileFTextFieldStyle on Never {
  static FTextFieldStyle textFieldStyle({
    ...
    final fontSize = 19.0;
    final boarderRad = BorderRadius.circular(15);
  ...
  static FLabelStyle _labelStyle({
    required FStyle style,
  ...
  static FButtonIconContentStyle _buttonIconContentStyle({
    required Color enabled,
    required Color disabled,
