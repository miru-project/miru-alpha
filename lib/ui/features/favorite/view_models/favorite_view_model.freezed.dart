...
class _FavoriteViewState implements FavoriteViewState {
  const _FavoriteViewState({required final  List<DomainFavoriteGroup> groups, required final  List<DomainFavorite> favorites, this.selectedGroupId}): _groups = groups,_favorites = favorites;
