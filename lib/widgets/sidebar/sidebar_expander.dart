...
class SidebarExpander extends StatefulWidget {
  const SidebarExpander({super.key, required this.title, required this.child, this.expanded = false, this.actions});
  final String title;
  final Widget child;
  final bool expanded;
            ...
            children: [
              Expanded(
                child: Button(
                  ...
                  child: Text(
                    widget.title,
                    style: TextStyle(color: context.moonTheme?.textInputTheme.colors.textColor, fontWeight: FontWeight.bold, fontSize: 13),
                  ),
                ),
              ),
